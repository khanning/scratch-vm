 ...
 */
const BLEUUID = {
    service: '4cdbbd87-d6e6-46c2-9d0b-df87551e159a',
    rxChar: '4cdb8702-d6e6-46c2-9d0b-df87551e159a'
};
...
class Scratch3ScratchBitBlocks {
    ...
    constructor (runtime) {
        ...
        this.runtime = runtime;
				...
				// Create a new ScratchBit device instance
        this._device = new ScratchBit(this.runtime, Scratch3ScratchBitBlocks.EXTENSION_ID);
    }
